...
public class Next4Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView na = findViewById(R.id.imgKe);
       ...
       // wa.setOnClickListener(this);
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                Intent myIntent = new Intent(getApplicationContext(), Next5Activity.class);
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.imgKe){
            Intent intent = new Intent(Next4Activity.this, Next5Activity.class);
            Bundle extras = new Bundle();
            count = Integer.parseInt(stringVariableName);
            count++;
            extras.putString("count", count + "");
