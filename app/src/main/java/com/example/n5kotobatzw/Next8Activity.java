...
public class Next8Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView na = findViewById(R.id.imgKo);
      ...
      //  o.setOnClickListener(this);
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                Intent myIntent = new Intent(getApplicationContext(), Next9Activity.class);
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.imgKo){
            Intent intent = new Intent(Next8Activity.this, Next9Activity.class);
            Bundle extras = new Bundle();
            count = Integer.parseInt(stringVariableName);
            count++;
            extras.putString("count", count + "");
