...
public class Next6Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView na = findViewById(R.id.imgSe);
       ...
       // yu.setOnClickListener(this);
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                Intent myIntent = new Intent(getApplicationContext(), Next7Activity.class);
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.imgSe){
            Intent intent = new Intent(Next6Activity.this, Next7Activity.class);
            Bundle extras = new Bundle();
            count = Integer.parseInt(stringVariableName);
            count++;
            extras.putString("count", count + "");
