...
public class Next5Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView na = findViewById(R.id.imgShi);
       ...
       // wa.setOnClickListener(this);
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                Intent myIntent = new Intent(getApplicationContext(), Next6Activity.class);
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.imgShi){
            Intent intent = new Intent(Next5Activity.this, Next6Activity.class);
            Bundle extras = new Bundle();
            count = Integer.parseInt(stringVariableName);
            count++;
            extras.putString("count", count + "");
