...
public class Next9Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView na = findViewById(R.id.imgKu);
       ...
       // o.setOnClickListener(this);
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                Intent myIntent = new Intent(getApplicationContext(), Next10Activity.class);
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.imgKu){
            Intent intent = new Intent(Next9Activity.this, Next10Activity.class);
            Bundle extras = new Bundle();
            count = Integer.parseInt(stringVariableName);
            count++;
            extras.putString("count", count + "");
